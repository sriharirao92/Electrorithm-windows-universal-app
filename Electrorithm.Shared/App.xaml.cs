...
namespace Electrorithm
{
    ...
    {
        private Guid APP_ID = new Guid("a678de28-52ae-46f2-9b51-a9ed79320423");
        public const string APP_NAME = "Electrorithm";
        ...
        private void UpdateAppTiles()
        {
            ...
            {
                TileServices.CreateFlipTile(@"Posts", @"");
